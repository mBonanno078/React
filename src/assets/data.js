  ...
  export const dataPeople = [
    {
      ...
      message: "No pain no Gain XOXO PALESTRA MUSCOLI POTENZA",
      avatar:
    ...
    },
    {
      ...
      message: "La musica è per l'anima quello che la ginnastica è per il corpo.",
      avatar:
    ...
    },
    {
      id: 3,
      name: "Mike Russel",
      message: "Non permettere a nessuno di dirti che non sei capace",
      avatar:
    ...
    },
    {
      ...
      message: "Non mangerei un hamburger nemmeno se mi pagassero 40,000 dollari",
      avatar:
